...
namespace cradle::config { void mark_dirty(); }
...
namespace cradle::modules
{
    ...
    void set_keybind(int k) { keybind = k; cradle::config::mark_dirty(); }
        KeybindMode get_keybind_mode() const { return keybind_mode; }
    void set_keybind_mode(KeybindMode mode) { keybind_mode = mode; cradle::config::mark_dirty(); }
