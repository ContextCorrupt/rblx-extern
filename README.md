# Mossad.is
an actively maintained free and open-source roblox external for version `version-b7e223555d904550`. if a newer roblox version is released, offsets will be updated and a new version of Mossad.is will be published.
...
```powershell
git clone https://github.com/wearish/mossad.is.git
cd mossad.is
cmake -S . -B build -G "Visual Studio 17 2022"
cmake --build build --config Release
```
after a successful build, the executable will be located at build\bin\release\mossad.exe.
a working build will also always be published in the releases tab.
